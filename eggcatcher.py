...
color_cycle=cycle(['light blue', 'light green', 'light pink', 'red', 'white', 'black', 'purple', 'gold'])
egg_width = 45
egg_height = 55
egg_score = 10
egg_speed = 500
...
catcher_start_x = canvas_width/2 - catcher_height/2
catcher_start_y = canvas_height - catcher_height - 20
catcher_start_x2 = catcher_start_x + catcher_width
catcher_start_y2 = catcher_start_y + catcher_height

catcher = c.create_arc(catcher_start_x,catcher_start_y,catcher_start_x2,catcher_start_y2,start=200, extent=140, style='arc', outline='blue', width=3)
...
def draw_egg():
    ...
    eggs.append(new_egg)
    win.after(egg_interval, draw_egg)
...
def move_left(event):
    ...
    if x1 > 0:
        c.move(catcher,-20,0)
    win.after(100, move_left)

def move_right(event):
    (x1,y1,x2,y2) = c.coords(catcher)
    if x2 < canvas_width:
        c.move(catcher,20,0)
    win.after(100, move_right)

c.bind('<Left>', move_left)
c.bind('<Right>', move_right)
c.focus_set()

win.after(1000, draw_egg)
